...
export default defineConfig({
  ...
  testMatch: ["browser-baseline.pw.ts", "ui-overhaul.pw.ts", "ui-review-follow-up.pw.ts", "movement-review.pw.ts", "ui-correction.pw.ts", "phone-book.pw.ts", "jump-camera.pw.ts", "tall-walls.pw.ts", "hazard-surfaces.pw.ts"],
  fullyParallel: false,
  workers: 1,
  retries: 0,
  timeout: 180_000,
