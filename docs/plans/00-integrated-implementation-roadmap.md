...
**Direct Human priority in flight: [EXPLORE-25](EXPLORE-25-spacious-maze.md).** Spacious square-cell maze, folding essentials rail and reversible Classic view are implemented on codex/expansive-exploration; final qualification is pending. Live remains0.22.24. After this request, resume DELIGHT A/C then LEARN-01; preserve all wider roadmap/Garden dependencies and physical-device observations.
