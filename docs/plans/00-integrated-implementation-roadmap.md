...
**Current delivery — DELIGHT26 A:** [steady pickup presence](DELIGHT-26-calm-pickup-presence.md)
is published as web0.22.26; [public receipt](../reviews/2026-09-07-v02226-public-verification.md).
C durable-earned keepsake presentation follows next, then LEARN-01 including
STORY-RESCUE-01. Keep the accepted geometry/reward owners and broader controls,
campaign/Garden roadmap. Earlier current/next labels below are historical.
