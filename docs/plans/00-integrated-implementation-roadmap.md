...
**Current qualification, 2026-09-06:** v0.22.6 AUDIO-01V2 is frozen at
`e628898bb4e501034f184a7a92c9e5e6d2b7a4aa`. Root Astra owns final native
qualification/publication; actual Sol independently reviews. Calibrated controls
and the compact high-combination warning are implemented. Release acceptance,
checksums, exact-source CI/deployment and public downloads are **pending**.
After this bounded release handoff, AUDIO-01A readiness is the next separate
implementation. P10 is queued; P5–P9 and the iPad camera gate remain cumulative.
...
currently owns the serial runtime/heavy slot for v0.22.6 AUDIO-01V2 qualification.
...
**Current owner: root Astra, actual Sol independent review**, completing
[AUDIO-01V2's joint decision](../reviews/2026-09-06-audio01v2-joint-decision.md)
at the frozen v0.22.6 candidate above, before AUDIO-01A. Calibrated 75%/75%
...
not establish all-range clip-free or physical listening acceptance. Final native/
release evidence is still pending; do not add an unreviewed limiter. V23-04 belongs to the later
...
| 5F | **[AUDIO-01V2 → AUDIO-01A](AUDIO-01-readiness-and-sound-design.md) — calibrated controls, then readiness/continuity** | Root Astra / actual Sol review: v0.22.6 `e628898` is in final qualification, publication pending. Implemented 75%/75% defaults matching old Music10%/SFX100%, exact gain-preserving version-aware persistence and conditionally reviewed 4/3 SFX with a visible combination warning. After release, separately advance AUDIO-01A bounded current-plus-one preparation, confirmed handover and synthesized-SFX readiness. | Final calibrated controls/native/release evidence remains pending; physical P10 listening stays separate. Then cold/warm/context/held-win/failure evidence, bounded streams/voices, canonical transport compatibility, truthful audibility limits and independent review. |
...
v0.22.6 qualification candidate `e628898`, with publication pending and actual Sol
review; AUDIO-01A follows its qualified release handoff as the next separate seam;
