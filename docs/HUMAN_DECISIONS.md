...
**September7 explicit UI steer:** [spacious exploration request](user-playtests/2026-09-07-spacious-maze-request.md) authorizes a non-square square-cell camera and width-changing folding essentials rail, superseding older square-only UI constraints. Newly visible real tiles reveal/discover consistently; Classic reverses presentation while knowledge remains monotonic. Engineering implementation is published in web0.22.25; Human layout and physical-device acceptance remain open (Q11/P25).
...
lip/fade under wall shadows. [Routing](reviews/2026-09-07-playtest-routing.md)
preserves WALL-04C first, then the bounded progression regression and HAZARD-03
before LOOT-03. These are authorized revisions; no further permission is needed.
