...
| Hosting | GitHub `main` is connected to the Vercel Hobby project at `https://maze-so-puzzle.vercel.app/` | Release commit `a05061e` auto-deployed; the canonical bundle reports 0.18.0 and all four new cage WebPs return HTTP 200 with exact local byte sizes |
