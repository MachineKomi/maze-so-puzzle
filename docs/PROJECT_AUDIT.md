...
| Hosting | GitHub `main` is connected to the Vercel Hobby project at `https://maze-so-puzzle.vercel.app/` | Source push and canonical 0.19.0 verification follow the release commit |
