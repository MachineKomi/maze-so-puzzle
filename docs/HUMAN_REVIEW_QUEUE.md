...
| --- | --- | --- |
| Q08 | On web0.22.18, try campaign maze2 and Lanternlight Labyrinth on iPhone13/iPad8 using the same browser, Full quality and Regular pace. Is camera travel smooth, including reversals and hole jumps? Also note any pause when first opening Gold/Science. Include OS/browser version and whether it worsens after a few minutes; the smooth iPhone17 is a useful control. | **Ready; priority P19, camera changes retained from17.** [Public proof](reviews/2026-09-07-v02218-public-verification.md), [report/limits](user-playtests/2026-09-07-modest-device-camera-stutter.md). The reported defect remains open pending actual device feedback; no RAM threshold is established. |
...
| Q05 | On0.22.18, open an authored Gold/Science pickup: are the burst, spin, bounces and pause readable and satisfying? Do distant drops stay until approached, with a pleasant accelerating pull and clear value? | **Ready on published0.22.18; P20.** [Public proof](reviews/2026-09-07-v02218-public-verification.md). Authored rewards only; Power remains immediate-rule. Enemy currencies, chests/Mimics, XP and eggs follow. No Human feel acceptance inferred. |
