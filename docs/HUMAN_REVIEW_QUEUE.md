...
| --- | --- | --- |
| Q08 | On web0.22.17, try campaign maze2 and Lanternlight Labyrinth on iPhone13/iPad8 using the same browser, Full quality and Regular pace. Is camera travel smooth, including reversals and hole jumps? Please include OS/browser version and whether it worsens after a few minutes; the smooth iPhone17 is a useful control. | **Ready on published0.22.17; priority P19.** [Public proof](reviews/2026-09-07-v02217-public-verification.md), [report/limits](user-playtests/2026-09-07-modest-device-camera-stutter.md). The reported defect remains open pending actual device feedback; no RAM threshold is established. |
...
[Cumulative family checklist](PLAYTEST_CHECKLIST.md) retains P5–P19, phone/audio,
