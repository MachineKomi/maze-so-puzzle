...
## Human exception revisions — blank-canvas r02 candidates

These prompts implement the Human's first Batch 01 exception list. The rejected
v01 candidates are preserved as evidence but are not used as generation or
rendering authority for the replacements.

### `enemy-lamia-v02-matte-01`

```text
Use case: stylized-concept
Asset type: isolated replacement enemy field sprite on a chroma-key matte for a child-friendly anime JRPG
Input images: Image 1 is the Human-approved four-enemy hybrid and defines the final clean chunky enemy-family rendering. Image 2 is the Human-selected Direction A core sampler and supplies two-to-four-mass economy and bright material-local contour confidence. Image 3 is the selected Direction A current-family transfer and supplies field scale and simplified surface detail. Do not use the rejected Lamia v01 output as a reference.
Primary request: Generate a new independent wholesome Lamia maze adventurer from a blank canvas. She is a compact young fantasy person with a warm friendly face, large teal-blue eyes, short dark-plum wavy hair with no ornament, and a modest fully covered coral tunic with cream collar and short lavender capelet. At the waist she transitions into one broad mint-green snake tail forming a simple grounded S-curve. The tail has clean broad scale planes and subtle value bands only—no leaves, flowers, vines, hearts, stars, or decorative body motifs. She carries a small rolled maze map tied with a plain coral ribbon and looks helpful but competitive.
Style/medium: Original clean chunky magical-girl storybook JRPG anime sprite; two to four dominant colour masses, exactly three broad cel-like values, restrained painterly facets, sparse detail, strong face and S-curve silhouette at 40–84 px. Match the approved family, not a separate illustration style.
Contours: Bright continuous material-local contours authored into the art: blue-leaf plum around mint scales, russet-plum around coral cloth, aubergine around dark hair and lavender cloth, golden-brown around the map, and darkest ink-plum only for eyes, mouth, waist occlusion, and tiny critical separations. The outer contour must be clearly coloured, not black.
Pose/camera: Compact front three-quarter full-body field pose, one-tile registration, complete tail tip and map visible, upright friendly eyeline.
Backdrop contract: One completely flat solid opaque #FF00FF chroma-magenta background. No checkerboard, pattern, gradient, vignette, texture, floor, cast shadow, aura, particles, scenery, or magenta spill.
Avoid: any leaf motif, adult curves, cleavage, bare midriff, glamour pose, constriction, forked tongue, fangs, weapon, excessive scales, filigree, cream sticker cutline, text, logo, watermark, franchise-specific lamia design.
```

### `enemy-soda-slime-v02-matte-01`

```text
Use case: stylized-concept
Asset type: isolated replacement enemy field sprite on a chroma-key matte for a child-friendly anime JRPG
Input images: Image 1 is the Human-approved four-enemy hybrid and defines the final clean chunky enemy-family rendering. Image 2 is the Human-selected Direction A core sampler and supplies two-to-four-mass economy and bright material-local contour confidence. Image 3 is the selected Direction A current-family transfer and supplies field scale and simplified surface detail. Do not use the rejected Soda Slime v01 output as a reference.
Primary request: Generate a new independent Soda Slime from a blank canvas. It must use the unmistakable simple traditional fantasy slime construction: one low rounded droplet mound with a broad base, two large friendly plum eyes with clear catchlights, and one tiny cheerful mouth. The creature is made from glossy cherry-coral soda gel rather than watery translucent gel. Suggest carbonation only through a few tiny bright pinprick fizz highlights distributed within the gel and a subtle sparkling surface sheen. Do not add three large bubble disks, a bottle-cap crest, a bottle, can, straw, label, fruit, text, or any accessory.
Style/medium: Original clean chunky magical-girl storybook JRPG anime sprite; two dominant colour masses, exactly three broad cel-like values, restrained softly painted gel transitions, very few internal lines, strong recognition at 40–84 px. No deep-fried texture or elaborate refraction.
Contours: Bright continuous material-local contour authored into the drawing: saturated raspberry-plum around coral soda gel, with darkest ink-plum reserved for eyes, mouth, deep occlusion, and tiny critical separations. The contour must read clearly chromatic, never like black ink or a post-process halo.
Pose/camera: Low front three-quarter field view, centered, complete compact one-tile silhouette.
Backdrop contract: One completely flat solid opaque #00E600 chroma-green background. No checkerboard, pattern, gradient, vignette, texture, floor, cast shadow, exterior glow, scenery, or green spill. The soda gel must remain visually self-contained and must not transmit the green matte.
Avoid: large decorative bubbles, cap or beverage packaging, real branding, photoreal carbonation, translucent background bleed, slime trail, menace, microtexture, cream sticker cutline, text, watermark, franchise-specific slime design.
```

### `enemy-minotaur-v02-matte-01`

```text
Use case: stylized-concept
Asset type: isolated replacement enemy field sprite on a chroma-key matte for a child-friendly anime JRPG
Input images: Image 1 is the Human-approved four-enemy hybrid and defines the final clean chunky enemy-family rendering. Image 2 is the Human-selected Direction A core sampler and supplies two-to-four-mass economy and bright material-local contour confidence. Image 3 is the selected Direction A current-family transfer and supplies field scale and simplified surface detail. Do not use the rejected Minotaur v01 output as a reference.
Primary request: Generate a new independent Minotaur maze guardian from a blank canvas: a stout rounded cinnamon-brown bull person with a big soft muzzle, large friendly teal eyes, two short blunt cream horns, small rounded ears, dark-russet forelock, simple mint scarf, lavender waistcoat, cream shorts, and sturdy coral boots. Replace the rejected direction-sign idea with one traditional fantasy minotaur axe: a chunky crescent-shaped cream-metal axe head with rounded safe edges on a short russet wooden haft. Hold it planted down beside the body in a calm ready pose, never swinging or aimed at the viewer. Strong and competitive rather than frightening.
Style/medium: Original clean chunky magical-girl storybook JRPG anime sprite; two to four dominant colour masses, exactly three broad cel-like values, restrained soft painted facets, sparse fur and material detail, strong 40–84 px silhouette. Match the approved enemy family.
Contours: Bright continuous material-local contours authored into the art: russet-plum around brown fur, wood and coral boots; leaf-plum around the mint scarf; aubergine around lavender cloth; warm golden-brown around horns and cream-metal axe; darkest ink-plum only for eyes, mouth, nostrils, deep occlusion, and tiny critical separations. No uniform black perimeter.
Pose/camera: Compact front three-quarter full-body planted field pose, one-tile registration, complete horns, axe, hands, feet and tail tip visible.
Backdrop contract: One completely flat solid opaque #00E5E5 chroma-cyan background. No checkerboard, pattern, gradient, vignette, texture, floor, cast shadow, dust, attack effect, scenery, or cyan spill.
Avoid: arrow sign, directions gesture, charge pose, nose ring, gore, rage, realistic bovine anatomy, skulls, spikes, oversized sharpened weapon, cream sticker cutline, text, logo, watermark, franchise-specific minotaur design.
```
