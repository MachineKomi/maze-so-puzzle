...
Both serve identical frozen v0.22.24 HTML/JS/CSS, verified2026-09-07 in the
[public receipt](reviews/2026-09-07-v02224-public-verification.md). Browser saves are
...
Current last successful production release: **6c9cddf34aa45dcf7594db3689c2a00b38586459**
(web0.22.24). Use the actual successful deployment as the guard baseline; later
