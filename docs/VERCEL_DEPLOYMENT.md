...
Both serve identical frozen v0.22.26 HTML/JS/CSS, verified2026-09-07 in the
[public receipt](reviews/2026-09-07-v02226-public-verification.md). Browser saves are
...
Current last successful production release: **fc32f8631404e5a8ebcc5d73cbdcfa89c48cda2f**
(web0.22.26). Use the actual successful deployment as the guard baseline; later
