...
Web is0.22.13, published Windows0.22.9 and R1/0.22.11 is unpromoted.
...
Test the version actually shown online, now0.22.13. No additional playtest is
needed merely to transfer files; P16 now supplies the changed wall comparison.
