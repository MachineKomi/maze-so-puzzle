...
build is wanted. Version 0.10.0 is the current verified Windows test build. Its
Tauri build, staging, portable smoke launch, source-to-stage comparison, and
hashes completed successfully on 2026-09-01.

## Current 0.10.0 test files

- `Maze-so-Puzzle-0.10.0-portable.exe` - standalone application executable,
  49,222,656 bytes. It remained running and responsive with the correct title in
  a five-second local smoke launch.
- `Maze-so-Puzzle-0.10.0-setup.exe` - NSIS installer, 42,694,296 bytes. It was
  built and staged but has not been clean-machine installed during this pass.

`SHA256SUMS.txt` contains their staged hashes plus retained 0.9.1, 0.9.0, 0.8.0, 0.7.1, 0.5.1,
...
```powershell
Get-FileHash .\Maze-so-Puzzle-0.10.0-portable.exe -Algorithm SHA256
Get-FileHash .\Maze-so-Puzzle-0.10.0-setup.exe -Algorithm SHA256
```

Expected hashes are:

- portable: `073EB840039176A3BF86B563A340271E9B41A37EFE2D469E36772A77A278F7F0`
- installer: `1A5C12CD9114727E82B23524A15CAF042D8F7F2495864BA7D889A8B4C9EC0073`
