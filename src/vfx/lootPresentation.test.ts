...
describe("physical loot presentation boundary",()=>{
  ...
  it("holds a stable Lite set, releases distant slots on approach and prioritizes accepted claims",()=>{
    const loot:LootLedger={version:3,runId:"run-capacity-test",legacyRetiredXpIds:[],legacyRetiredEnemyIds:[],sources:[{sourceId:"capacity",sourceKind:"treasure",objectId:"capacity",currency:"gold",amount:12,credited:0,
